...
const bookMark = (restaurant) => {
    ...
    let tempHtml = `        
        ...
        <button class="button is-xs is-inline-block" onclick="delMark(${_id}, ${min_order.toLocaleString()})" onmouseover="">⨉</button></li>`
        ...
        .then((restaurant) => {
            ...
            <div class="pop-up-card">
                ...
                <div class="pop-card-content-2">
                    ...
                    <div class="pop-card-min">${min_order ? min_order.toLocaleString() : "---"} 원 이상 주문가능</div>
    ...
    <div class="food-card card">
        ...
        <div class="tool-box">
            ...
            <div class="card-footer">
                <div>${address}<br>영업시간: ${time}<br>${min_order.toLocaleString()}원 이상 주문 가능</div>
                <div class="reviews">
                    <div class="reviews-count">주문자리뷰 ${reviews.toLocaleString()}<br>사장님댓글 ${owner.toLocaleString()}</div>
                </div>
            </div>
        </div>
    </div>`
